...
// 表锁 set
  void SetTableIntentionSharedLocked(const table_oid_t &oid) {
      is_table_lock_set_->insert(oid);
  }

  void SetTableSharedLocked(const table_oid_t &oid) {
      s_table_lock_set_->insert(oid);
  }

  void SetTableIntentionExclusiveLocked(const table_oid_t &oid) {
      ix_table_lock_set_->insert(oid);
  }

  void SetTableExclusiveLocked(const table_oid_t &oid) {
      x_table_lock_set_->insert(oid);
  }

  void SetTableSharedIntentionExclusiveLocked(const table_oid_t &oid) {
